...
export const NotificationUI = ({openNotification}:{
    ...
    return(
        <div className={`absolute bg-black/100 border ${openNotification ? "block" : " hidden"} border-blue-700 top-[4em] right-[6%] w-[20rem] p-4 rounded-xl z-10 h-[373px] overflow-y-auto`}>
            <div className="">
                {
